...
station_id=$WEATHERFLOW_LISTENER_REMOTE_COLLECTOR_STATION_ID
...
echo "$WEATHERFLOW_LISTENER_COLLECTOR_TYPE"
echo "$WEATHERFLOW_LISTENER_BACKEND_TYPE"
echo "$WEATHERFLOW_LISTENER_DEBUG"
echo "$WEATHERFLOW_LISTENER_INFLUXDB_PASSWORD"
echo "$WEATHERFLOW_LISTENER_INFLUXDB_URL"
echo "$WEATHERFLOW_LISTENER_INFLUXDB_USERNAME"
echo "$WEATHERFLOW_LISTENER_REMOTE_COLLECTOR_DEVICE_ID"
echo "$WEATHERFLOW_LISTENER_REMOTE_COLLECTOR_STATION_ID"
echo "$WEATHERFLOW_LISTENER_REMOTE_COLLECTOR_TOKEN"
