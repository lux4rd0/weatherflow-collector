...
station_id=$WEATHERFLOW_LISTENER_REST_STATION_ID
...
echo "$WEATHERFLOW_LISTENER_API_TYPE"
...
echo "$WEATHERFLOW_LISTENER_REST_DEVICE_ID"
echo "$WEATHERFLOW_LISTENER_REST_STATION_ID"
echo "$WEATHERFLOW_LISTENER_REST_TOKEN"
