...
##
## WeatherFlow Collector - exec-local-udp.sh
##
...
echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - Starting WeatherFlow Collector (local-udp.sh) - https://github.com/lux4rd0/weatherflow-collector
...
if [ "${line}" == "null" ]; then echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - No valid udp-local data."; exit 0; fi
...
if [ "$debug" == "true" ]; then echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - timer_loki_duration:${timer_loki_duration}"; fi
...
if [ "${wind_lull}" != "null" ]; then curl_message="${curl_message}wind_lull=${wind_lull},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_lull is null"; fi
if [ "${wind_avg}" != "null" ]; then curl_message="${curl_message}wind_avg=${wind_avg},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_avg is null"; fi
if [ "${wind_gust}" != "null" ]; then curl_message="${curl_message}wind_gust=${wind_gust},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_gust is null"; fi
if [ "${wind_direction}" != "null" ]; then curl_message="${curl_message}wind_direction=${wind_direction},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_direction is null"; fi
if [ "${wind_sample_interval}" != "null" ]; then curl_message="${curl_message}wind_sample_interval=${wind_sample_interval},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_sample_interval is null"; fi
...
if [ "${relative_humidity}" != "null" ]; then curl_message="${curl_message}relative_humidity=${relative_humidity},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - relative_humidity is null"; fi
if [ "${illuminance}" != "null" ]; then curl_message="${curl_message}illuminance=${illuminance},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - illuminance is null"; fi
if [ "${uv}" != "null" ]; then curl_message="${curl_message}uv=${uv},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - uv is null"; fi
if [ "${solar_radiation}" != "null" ]; then curl_message="${curl_message}solar_radiation=${solar_radiation},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - solar_radiation is null"; fi
if [ "${precip_accumulated}" != "null" ]; then curl_message="${curl_message}precip_accumulated=${precip_accumulated},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - precip_accumulated is null"; fi
if [ "${precipitation_type}" != "null" ]; then curl_message="${curl_message}precipitation_type=${precipitation_type},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - precipitation_type is null"; fi
if [ "${lightning_strike_avg_distance}" != "null" ]; then curl_message="${curl_message}lightning_strike_avg_distance=${lightning_strike_avg_distance},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - lightning_strike_avg_distance is null"; fi
if [ "${lightning_strike_count}" != "null" ]; then curl_message="${curl_message}lightning_strike_count=${lightning_strike_count},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - lightning_strike_count is null"; fi
if [ "${battery}" != "null" ]; then curl_message="${curl_message}battery=${battery},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - battery is null"; fi
if [ "${report_interval}" != "null" ]; then curl_message="${curl_message}report_interval=${report_interval}"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - report_interval is null"; fi
...
if [ "${time_epoch}" != "null" ]; then curl_message="${curl_message}time_epoch=${time_epoch}000,"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - time_epoch is null"; fi
if [ "${wind_speed}" != "null" ]; then curl_message="${curl_message}wind_speed=${wind_speed},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_speed is null"; fi
if [ "${wind_direction}" != "null" ]; then curl_message="${curl_message}wind_direction=${wind_direction}"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - wind_direction is null"; fi
...
if [ "${time_epoch}" != "null" ]; then curl_message="${curl_message}time_epoch=${time_epoch}000,"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - time_epoch is null"; fi
if [ "${distance}" != "null" ]; then curl_message="${curl_message}distance=${distance},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - distance is null"; fi
if [ "${energy}" != "null" ]; then curl_message="${curl_message}energy=${energy}"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - energy is null"; fi
...
if [ "${timestamp}" != "null" ]; then curl_message="${curl_message}timestamp=${timestamp}000,"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - timestamp is null"; fi
if [ "${uptime}" != "null" ]; then curl_message="${curl_message}uptime=${uptime},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - uptime is null"; fi
if [ "${voltage}" != "null" ]; then curl_message="${curl_message}voltage=${voltage},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - voltage is null"; fi
if [ "${firmware_revision}" != "null" ]; then curl_message="${curl_message}firmware_revision=${firmware_revision},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - firmware_revision is null"; fi
if [ "${rssi}" != "null" ]; then curl_message="${curl_message}rssi=${rssi},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - rssi is null"; fi
if [ "${hub_rssi}" != "null" ]; then curl_message="${curl_message}hub_rssi=${hub_rssi},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - hub_rssi is null"; fi
if [ "${sensor_status}" != "null" ]; then curl_message="${curl_message}sensor_status=${sensor_status}"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - sensor_status is null"; fi
...
if [ "${rssi}" != "null" ]; then curl_message="${curl_message}rssi=${rssi},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - rssi is null"; fi
if [ "${timestamp}" != "null" ]; then curl_message="${curl_message}timestamp=${timestamp}000,"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - timestamp is null"; fi
if [ "${radio_stats_version}" != "null" ]; then curl_message="${curl_message}radio_stats_version=${radio_stats_version},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - radio_stats_version is null"; fi
if [ "${radio_stats_reboot_count}" != "null" ]; then curl_message="${curl_message}radio_stats_reboot_count=${radio_stats_reboot_count},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - radio_stats_reboot_count is null"; fi
if [ "${radio_stats_i2c_bus_error_count}" != "null" ]; then curl_message="${curl_message}radio_stats_i2c_bus_error_count=${radio_stats_i2c_bus_error_count},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - radio_stats_i2c_bus_error_count is null"; fi
if [ "${radio_stats_radio_status}" != "null" ]; then curl_message="${curl_message}radio_stats_radio_status=${radio_stats_radio_status},"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - radio_stats_radio_status is null"; fi
if [ "${radio_stats_radio_network_id}" != "null" ]; then curl_message="${curl_message}radio_stats_radio_network_id=${radio_stats_radio_network_id}"; else echo "${echo_bold}${echo_color_local_udp}${collector_type}:${echo_normal} $(date) - radio_stats_radio_network_id is null"; fi
